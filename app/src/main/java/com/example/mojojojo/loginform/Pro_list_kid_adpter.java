...
class Pro_list_kid_adpter  extends BaseAdapter{
    ...
    public Pro_list_kid_adpter(pro_list_kid pro_list_kid, int pro_lismen_raw, int[] proimg, String[] protxt, String[] pro_detail, String[] rs, String[] price) {
        this.context=pro_list_kid;
