...
public class ProductListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sub_category_id = getIntent().getStringExtra("sub_key");
        Log.e(TAG, "onCreate: "+sub_category_id );
...
//            String[] proid = {"1", "2"};
//
//            int[] proimg = {R.drawable.catbook, R.drawable.catbook};
//
    ...
    private void setOnClickListener() {
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                MyParam.selectedProduct = (Product) productList.get(i);
    ...
    private void getProductList() {
        ...
        NetworkCall.call(param).setDataResponseListener(new NetworkCall.SetDataResponse() {
            ...
            public void setResponse(String responseStr) {
                ...
                productList = jsn.getAllObjectFromString(responseStr, Product.class);
                ProductListAdapter pro_list_adpter = new ProductListAdapter(ProductListActivity.this, R.layout.pro_lismen_raw,
                        productList);
