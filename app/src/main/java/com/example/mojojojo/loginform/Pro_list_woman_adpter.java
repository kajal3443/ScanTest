...
class Pro_list_woman_adpter extends BaseAdapter {
    ...
    public Pro_list_woman_adpter(pro_list_woman pro_list_woman, int pro_lismen_raw, int[] proimg, String[] protxt, String[] pro_detail, String[] rs, String[] price) {
        this.context=pro_list_woman;
